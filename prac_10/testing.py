...
def run_tests():
    ...
    car.add_fuel(10)
    assert car.fuel == 20, "Car does not set fuel correctly"
...
def sentence_a_string(string):
    """
    Give a string a capital letter and full stop
    >>> sentence_a_string("hello")
    'Hello.'
    >>> sentence_a_string("It is an ex parrot.")
    'It is an ex parrot.'
    >>> sentence_a_string("this should be a sentence")
